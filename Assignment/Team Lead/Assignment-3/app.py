...
COS_API_KEY_ID="1cnRO7RphlMsBBRzqhWATAsNZOmkKFpBy5rABkxVMwyY"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/d4d036d0aa6b45998fa7e766d55d973f:e774e223-6998-443f-9217-4ac03c7b474b::"
...
@app.route('/')
def index():
    files = get_bucket_contents('nethiran')
